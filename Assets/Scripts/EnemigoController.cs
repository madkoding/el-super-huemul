...
public class EnemigoController : MonoBehaviour
{
	...
	void Update()
	{
		...
		Vector2 rayDirection = new Vector2(direccionMovimiento.x, -1); // Hacia abajo y en la dirección de movimiento
		...
		if (player != null)
		{
			...
			if (distanciaAlJugador <= rangoDeteccion && !bordeDetectado)
			{
